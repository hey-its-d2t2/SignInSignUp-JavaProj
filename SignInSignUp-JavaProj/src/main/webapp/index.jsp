...
<title>SignIn/SignUp Ptoject Deepak Sing</title>
<!-- Favicon-->
...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">Deepak Singh</a>
			<button
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					...
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="LogoutSrv">Logout</a></li>
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Hello from
				Deepak Singh</h1>
			<!-- Icon Divider-->
			...
			<!-- Masthead Subheading-->
			<p class="masthead-subheading font-weight-light mb-0">Design -
				Develope - Secure</p>
		</div>
	</header>
	<!-- Portfolio Section-->
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 ms-auto">
					<p class="lead">Design - Develop - Secure Tech Startup
						Co-Founder, TheCoding Wala | Cyber Security Enthusiast | Software
						Developer | Web Developer | Visual Designer | Lifelong Learner |
						Observer | Visionary | Optimist | Still learning...</p>
				</div>
				<div class="col-lg-4 me-auto">
					<p class="lead">I am highly motivated to obtain a full-time
						software developer role where I can utilize my creativity,
						determination, and strategic mindset to produce impactful and
						revolutionary outcomes.</p>
				</div>
			</div>
			...
			<div class="text-center mt-4">
				<a class="btn btn-xl btn-outline-light"
					...
					class="fas fa-download me-2"></i> Download Resume
				</a>
			</div>
		</div>
	</section>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4 mb-5 mb-lg-0">
					...
					<p class="lead mb-0">
						Bhagalpur, Bihar - India <br /> +91 0000000000
					</p>
				</div>
				<!-- Footer Social Icons-->
				<div class="col-lg-4 mb-5 mb-lg-0">
				...
				<!-- Footer About Text-->
				<div class="col-lg-4">
					<h4 class="text-uppercase mb-4">Deepak Singh</h4>
					<p class="lead mb-0">"Embrace the challenges, unlock your
						potential."</p>
				</div>
			</div>
		</div>
	...
	<div class="copyright py-4 text-center text-white">
		<div class="container">
			<small>Copyright &copy; Deepak Singh 2023</small>
		</div>
	</div>
	<!-- Portfolio Modals-->
	<!-- Portfolio Modal 1-->
